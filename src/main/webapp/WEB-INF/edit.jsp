...
<body class="h-100 text-center bg-light">
	<nav class="navbar navbar-expand-lg">
		<a class="navbar-brand p-3" href="/dashboard">Welcome, <c:out value="${userName }" /></a>
	...
	<hr>
   <div class="container">
		<form:form class="w-50" action="/medications/edit/${oneMedication.id}" method="put" modelAttribute="oneMedication">
